...
/**
 * handle_hash - Function that handle the hash for non interactive mode.
 * @m: a struct.
 * @i: the index.
 * Return: nothing
 */
...
/**
 * handle_double_dollar - Function that handles the double dollar sign.
 * @m: a struct.
 * @i: the index.
 * Return: nothing
 */
...
/**
 * handle_double_mark - unction that handles the double mark.
 * @m: a struct.
 * @i: the index.
 * Return: nothing
 */
